...
func InitEnv() {
	...
	LegacyQuotaFrozen = GetEnvOrDefaultBool("LEGACY_QUOTA_FROZEN", false)
...
func initConstantEnv() {
	...
	constant.ClientGoneFallbackEnabled = GetEnvOrDefaultBool("CLIENT_GONE_FALLBACK_ENABLED", false)
