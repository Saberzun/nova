...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		storeRoute.Use(middleware.UserAuth())
		{
			...
			storeRoute.GET("/gift", controller.GetGiftSelf)
			storeRoute.GET("/notice", controller.GetStoreNotice)
			storeRoute.POST("/notice/dismiss", controller.DismissStoreNotice)
			...
			storeRoute.POST("/corporate-transfers/:application_no/evidence", middleware.CriticalRateLimit(), controller.UploadCorporateTransferEvidence)
			storeRoute.POST("/corporate-transfers/:application_no/reply", controller.ReplyCorporateTransferTicket)
			storeRoute.POST("/corporate-transfers/:application_no/cancel", middleware.CriticalRateLimit(), controller.CancelCorporateTransfer)
			storeRoute.GET("/corporate-transfers/attachments/:id", controller.GetCorporateTransferAttachment)
			storeRoute.GET("/corporate-transfers/collection-assets/:id", controller.GetCorporateCollectionAsset)
		}
		...
		storeAdminRoute := apiRouter.Group("/store/admin")
		storeAdminRoute.Use(middleware.RootAuth())
		{
			storeAdminRoute.GET("/notice", controller.AdminGetStoreNotice)
			storeAdminRoute.PUT("/notice/draft", controller.AdminSaveStoreNoticeDraft)
			storeAdminRoute.POST("/notice/publish", controller.AdminPublishStoreNotice)
			storeAdminRoute.GET("/corporate-transfer/collection", controller.AdminGetCorporateCollection)
			storeAdminRoute.PUT("/corporate-transfer/collection/draft", controller.AdminSaveCorporateCollection)
			storeAdminRoute.POST("/corporate-transfer/collection/publish", controller.AdminPublishCorporateCollection)
			storeAdminRoute.POST("/corporate-transfer/collection/assets", controller.AdminUploadCorporateCollectionAsset)
		}
		corporateTransferAdminRoute := apiRouter.Group("/store/admin/corporate-transfers")
		corporateTransferAdminRoute.Use(middleware.AdminAuth())
		{
			corporateTransferAdminRoute.GET("", controller.AdminListCorporateTransfers)
			corporateTransferAdminRoute.GET("/tickets/:ticket_no", controller.AdminGetCorporateTransferTicket)
			corporateTransferAdminRoute.POST("/:application_no/reply", controller.AdminReplyCorporateTransferTicket)
			corporateTransferAdminRoute.POST("/:application_no/ticket-state", controller.AdminSetCorporateTransferTicketOpen)
			corporateTransferAdminRoute.POST("/:application_no/request-info", controller.AdminRequestCorporateTransferInfo)
			corporateTransferAdminRoute.POST("/:application_no/reject", controller.AdminRejectCorporateTransfer)
			corporateTransferAdminRoute.POST("/:application_no/receipts", controller.AdminAddCorporateReceipt)
			corporateTransferAdminRoute.POST("/receipts/:receipt_id/void", controller.AdminVoidCorporateReceipt)
			corporateTransferAdminRoute.POST("/:application_no/approve", middleware.CriticalRateLimit(), controller.AdminApproveCorporateTransfer)
			corporateTransferAdminRoute.POST("/:application_no/refund", middleware.CriticalRateLimit(), controller.AdminRegisterCorporateTransferRefund)
		}
		...
		entitlementAdminRoute.Use(middleware.AdminAuth())
		{
			...
			entitlementAdminRoute.DELETE("/skus/:id", controller.AdminDeleteProductSKU)
			entitlementAdminRoute.GET("/orders", controller.AdminListProductOrders)
			entitlementAdminRoute.GET("/gift/settings", controller.AdminGetGiftSettings)
			entitlementAdminRoute.PUT("/gift/settings", controller.AdminSaveGiftSettings)
			entitlementAdminRoute.GET("/users/:id/gift", controller.AdminGetUserGift)
			entitlementAdminRoute.POST("/users/:id/gift", controller.AdminAdjustGift)
			entitlementAdminRoute.POST("/gift/referrals/release", controller.AdminReleaseReferralRewards)
			entitlementAdminRoute.GET("/gift/audit", controller.AdminAuditGiftAccounting)
			entitlementAdminRoute.POST("/gift/freeze-legacy-quota", controller.AdminFreezeLegacyQuota)
			...
			entitlementAdminRoute.POST("/users/:id/entitlements/from-sku", controller.AdminGrantProductSKUEntitlement)
			...
			entitlementAdminRoute.POST("/entitlements/:id/pause", controller.AdminPauseEntitlement)
			entitlementAdminRoute.POST("/entitlements/:id/resume", controller.AdminResumeEntitlement)
